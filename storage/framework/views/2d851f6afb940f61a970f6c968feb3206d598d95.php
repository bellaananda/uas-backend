...
<?php $__env->startSection('title', 'Ubah Agama'); ?>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <form action="/agama24/<?php echo e($agama['id']); ?>" method="post" id="inputForm" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>

                        <input type="hidden" name="id" id="id" value="<?php echo e($agama['id']); ?>" />
                        <div class="form-group">
                            <label for="name">Agama</label>
                            <input type="text" id="name" name="name" class="form-control" placeholder="Nama Agama" value="<?php echo e(old('name', $agama['name'])); ?>" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PRAK_BACKEND\laravel-uas\resources\views/admin/agama/edit.blade.php ENDPATH**/ ?>