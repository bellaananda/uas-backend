...
<head>
    ...
    <title>UAS Praktik Pemrograman Backend | - Register</title>
            ...
            <div class="card-body">
                <form action="/register24" method="post" class="form-signin w-100 m-auto">
                    ...
                    <div class="form-floating my-3 text-secondary">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Full name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
...
<?php /**PATH C:\wamp64\www\PRAK_BACKEND\laravel-uas\resources\views/auth/register.blade.php ENDPATH**/ ?>