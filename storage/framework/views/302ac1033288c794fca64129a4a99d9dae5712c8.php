...
<?php $__env->startSection('title', 'Ubah Detail'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="card card-primary">
        ...
        <div class="card-body">
            <form action="/detail24/<?php echo e($detail['id']); ?>" method="post" id="inputForm" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <input type="hidden" id="id" name="id" value="<?php echo e($detail['id']); ?>">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="birthplace" name="birthplace" class="form-control" placeholder="Tempat Lahir" value="<?php echo e(old('birthplace', $detail['birth_place'])); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="birthdate" name="birthdate" class="form-control" placeholder="Tanggal Lahir" value="<?php echo e(old('birthdate', $detail['birth_date'])); ?>" required>
                        ...
                        <div class="form-group">
                            ...
                            <select id="agama" name="agama" class="form-control custom-select" required>
                                ...
                                <?php $__currentLoopData = $agama; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($item['id'] == $detail['id_agama']): ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea id="address" name="address" class="form-control" rows="4" placeholder="Alamat" required><?php echo e(old('address', $detail['address'])); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="foto_ktp" name="foto_ktp" value="<?php echo e($detail['foto_ktp']); ?>">
    ...
    <!-- /.card -->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PRAK_BACKEND\laravel-uas\resources\views/user/detail/edit.blade.php ENDPATH**/ ?>