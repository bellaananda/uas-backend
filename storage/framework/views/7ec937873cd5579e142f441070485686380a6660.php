            ...
            <div class="card card-outline card-info">
                <div class="card-header border-transparent">
                    ...
                    <div class="card-tools">
                        ...
                        <?php else: ?>
                            <img src="<?php echo e(URL('./uploads/profile/' . Auth::user()->photo)); ?>" class="img-circle elevation-2" alt="User Image" width="50" height="50">
                        <?php endif; ?>
                    </div>
                </div>
                <!-- /.card-header -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\PRAK_BACKEND\laravel-uts\resources\views/admin/datadetails.blade.php ENDPATH**/ ?>