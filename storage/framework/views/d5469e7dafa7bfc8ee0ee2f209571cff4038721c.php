            ...
            <div class="card-body">
                <form action="/login24" method="post" class="form-signin w-100 m-auto">
                    ...
                    <div class="form-floating my-3 text-secondary">
                        <input type="email" class="form-control" id="email" name="email" placeholder="Email" value="<?php echo e(old('email')); ?>" required autofocus>
...
<?php /**PATH C:\wamp64\www\PRAK_BACKEND\laravel-uas\resources\views/auth/login.blade.php ENDPATH**/ ?>